...
const LIFE_SAVING_RULES: RuleItem[] = [
  {
    ...
    criticalControls:
      'Inertia fall arresters, drop netting, scaffold toe-boards, tool tethering lanyards (DROPS compliance).',
  ...
  },
  {
    ...
    criticalControls:
      'Double block and bleed (DBB), slip blind installation board, lockbox key control protocol.',
  ...
  },
  {
    ...
    criticalControls:
      'Forced air ventilation blowers (certified ATEX Zone 1), mechanical retrieval tripod, lifeline tether.',
  ...
  },
  {
    ...
    criticalControls:
      'Outrigger steel load-spreading mats, anti-two-block limiters, rated synthetic fiber tag-lines.',
  ...
  },
  {
    ...
    criticalControls:
      'Flange safety spray shields, high-pressure iron inspection logs, iron roughneck interlocking gates.',
  ...
  },
  {
    ...
    criticalControls:
      'Fire-resistant habitat enclosures with positive pressure fans, flammable gas interlock cutoffs.',
  ...
  },
  {
    ...
    criticalControls:
      'Trapped key interlock systems, password-protected safety PLC trip logic, automated bypass alarms.',
  ...
  },
  {
    ...
    criticalControls:
      'Fixed optical H2S perimeter sensors, automated wellhead shut-in valves, emergency cascade air banks.',
  ...
  },
  {
    ...
    criticalControls:
      'In-Vehicle Telematics (IVMS), electronic speed limiters, journey management approval system.',
...
const PTW_TYPES = [
  {
    ...
    scope:
      'Welding, gas cutting, grinding, torch brazing in Zone 1/2 process envelopes.',
  },
  {
    code: 'PTW-02',
    ...
    scope:
      'Mechanical bolt torquing, non-sparking pipe repairs, scaffolding, painting.',
  },
  {
    code: 'PTW-03',
    ...
    scope:
      'Tanks, separator vessels, sumps, flare knockout drums, pits > 1.2m deep.',
  },
  {
    code: 'PTW-04',
    ...
    scope:
      'MCC 415V/6.6kV breaker rack-out, transformer maintenance, motor overhaul.',
  },
  {
    code: 'PTW-05',
    ...
    scope:
      'Mast maintenance, flare tip inspection, derrick monkey board operations > 1.8m.',
  },
];

const EMERGENCY_CONTACTS = [
  {
    field: 'Duliajan Central',
    role: 'Emergency Control Room',
    phone: '+91-374-280-4444',
    channel: 'VHF Ch 16',
  },
  {
    field: 'Naharkatia GGS',
    role: 'Asset Fire & Safety',
    phone: '+91-374-280-5511',
    channel: 'VHF Ch 12',
  },
  {
    field: 'Moran Platform',
    role: 'HSE Shift Coordinator',
    phone: '+91-374-280-6622',
    channel: 'VHF Ch 14',
  },
  {
    field: 'Jorajan Field',
    role: 'Wellhead Response Lead',
    phone: '+91-374-280-7733',
    channel: 'VHF Ch 10',
  },
  {
    field: 'Digboi Drilling',
    role: 'Drilling Superintendent',
    phone: '+91-374-280-8844',
    channel: 'VHF Ch 08',
  },
  {
    field: 'Sadiya Asset',
    role: 'Emergency Dispatcher',
    phone: '+91-374-280-9955',
    channel: 'VHF Ch 11',
  },
];
...
export default function GuidelinesPage() {
  ...
  const handleDownloadPdf = () => {
    toast.success('Safety Guidelines Handbook Exported', {
      description:
        'Downloaded Oil India Limited HSE Safety Pocket Guide (PDF).',
    });
  };
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12 animate-in fade-in-50 duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#E4E7EC] pb-5">
        <div className="flex items-center space-x-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-[2px] bg-[#102F3E] text-white shadow-none">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge
                variant="outline"
                className="border-[#E4E7EC] text-[#17202A] bg-white text-[10px] font-semibold"
              >
                IOGP 459 / OISD
              </Badge>
            </div>
            ...
            <p className="text-xs text-[#667085] mt-1 font-normal">
              Oil India Limited • Mandatory Life-Saving Rules, Permit-to-Work
              Specifications &amp; Field Emergency Contacts
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <Button
            ...
            className="text-xs h-8 bg-[#102F3E] hover:bg-[#082735] text-white gap-1.5 shadow-none rounded-[2px]"
          >
      ...
      <Tabs defaultValue="lsr" className="space-y-4">
        ...
        <TabsContent value="lsr" className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground">
              Showing {filteredRules.length} of {LIFE_SAVING_RULES.length}{' '}
              standards
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredRules.map((rule) => (
              <Card
                key={rule.id}
                className="border bg-card shadow-none rounded-[2px] hover:border-[#102F3E]/40 transition-all flex flex-col"
              >
                <CardHeader className="p-4 pb-2 border-b bg-muted/20">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center space-x-2.5">
                      <div className="p-2 rounded-[2px] bg-background border shadow-none shrink-0">
                ...
                <CardContent className="p-4 space-y-3.5 text-xs flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-2 border-t space-y-1.5 bg-muted/20 -mx-4 -mb-4 p-3 rounded-b-[2px]">
                    <div>
        ...
        <TabsContent value="ptw" className="space-y-4">
          <Card className="border shadow-none rounded-[2px]">
            <CardHeader className="p-4 border-b">
              ...
              <CardDescription className="text-xs">
                Classification, validity timeframes, atmospheric testing
                requirements, and signoff hierarchy under OISD-STD-105
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {PTW_TYPES.map((ptw) => (
                  <div
                    key={ptw.code}
                    className={`p-4 rounded-[2px] border ${ptw.color} flex flex-col justify-between space-y-3`}
                  >
                    <div>
                      <div className="flex items-center justify-between">
                        <span
                          className={`font-mono text-xs font-bold ${ptw.textColor}`}
                        >
                          {ptw.code}
                        </span>
        ...
        <TabsContent value="emergency" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            {/* Siren Protocols */}
            <Card className="border shadow-none rounded-[2px] lg:col-span-2">
              <CardHeader className="p-4 border-b">
                ...
                <CardDescription className="text-xs">
                  Immediate evacuation and response protocols in event of toxic
                  gas blowout or facility emergency
                </CardDescription>
              </CardHeader>

              <CardContent className="p-4 space-y-4 text-xs">
                <div className="space-y-3">
                  <div className="p-3 rounded-[2px] border bg-rose-500/5 border-rose-500/20 space-y-1">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-rose-600 dark:text-rose-400">
                        Major Gas Leak / Blowout Alert (Intermittent Warble
                        Siren)
                      </span>
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      Shut down all rotating machinery, activate Emergency
                      Shutdown (ESD) push-button, extinguish open fires, observe
                      windsock, and evacuate immediately upwind/crosswind to
                      designated Primary Muster Point.
                    </p>
                  </div>

                  <div className="p-3 rounded-[2px] border bg-amber-500/5 border-amber-500/20 space-y-1">
                    <div className="flex items-center justify-between">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      Clear work area immediately, do not attempt to retrieve
                      personal items, report to designated Asset Fire Squad,
                      and maintain radio silence on VHF Channel 16.
                    </p>
                  </div>

                  <div className="p-3 rounded-[2px] border bg-emerald-500/5 border-emerald-500/20 space-y-1">
                    <div className="flex items-center justify-between">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      Statutory gas clearance confirmed by certified safety
                      officer; resume operations only after head count
                      reconciliation and formal PTW re-authorization.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border shadow-none rounded-[2px]">
              ...
              <CardContent className="p-4 space-y-2.5">
                {EMERGENCY_CONTACTS.map((c, idx) => (
                  <div
                    key={idx}
                    className="p-2.5 rounded-[2px] border bg-card/60 flex items-center justify-between hover:bg-muted/30 transition-colors"
                  >
                    <div>
                    ...
                    <div className="text-right">
                      <a
                        href={`tel:${c.phone}`}
                        className="font-mono text-xs font-semibold text-[#102F3E] hover:underline block"
                      >
                        {c.phone}
                      </a>
